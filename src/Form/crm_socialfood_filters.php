...
class crm_socialfood_filters extends FormBase
{
  /**
   * {@inheritdoc}
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['lugar_socialfood'] = [
      '#type' => 'radios',
      '#title' => 'LUGAR DE LA SOCIALFOOD',
      '#options' => [
        'form' => $this->t('casa'),
        'form1' => $this->t('con vistas'),
        'form2' => $this->t('aire libre'),
        'form3' => $this->t('otros'),
      ],
      '#attributes' => ['class' => ['crm-radio-lugar']],
      '#default_value' => 'form',
    ];
    return $form;
  }
